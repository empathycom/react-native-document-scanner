...
# `@empathy/react-native-document-scanner`

[![CircleCI Status](https://img.shields.io/circleci/project/github/empathy/react-native-document-scanner/master.svg)](https://circleci.com/gh/empathy/workflows/react-native-document-scanner/tree/master) ![Supports Android and iOS](https://img.shields.io/badge/platforms-android%20|%20ios%20-lightgrey.svg) ![MIT License](https://img.shields.io/npm/l/@react-native-community/netinfo.svg)
...
> Use [version `1.6.2`](https://github.com/empathycom/react-native-document-scanner/tree/v1.6.2) if you are using React Native 0.59

Install the library using either yarn:

```sh
yarn add @empathy/react-native-document-scanner`
```

or npm:

```sh
npm install @empathy/react-native-document-scanner --save
```
...
project(':openCVLibrary310').projectDir = new File(rootProject.projectDir,'../node_modules/@empathy/react-native-document-scanner/android/openCVLibrary310')
```
...
import DocumentScanner from "@empathy/react-native-document-scanner"
...
Full example in [example folder](https://github.com/empathycom/react-native-document-scanner/tree/master/example).
